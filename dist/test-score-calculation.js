...
const scoreCalculators_1 = require("./src/utils/scoreCalculators");
...
const raceCalc = new scoreCalculators_1.RaceScoreCalculator(realRace, guessRace);
const qualifyingCalc = new scoreCalculators_1.QualifyingScoreCalculator(realQualifying, guessQualifying);
...
const raceCalc2 = new scoreCalculators_1.RaceScoreCalculator(realRace2, guessRace2);
const qualifyingCalc2 = new scoreCalculators_1.QualifyingScoreCalculator(realQualifying2, guessQualifying2);
